...
// ControllerManager loads hardware plugins through a
// pluginlib::ClassLoader<hardware_interface::SystemInterface>; the factory
// above alone is invisible to it. Register the same class under
// hardware_interface::SystemInterface as well (same TU: no ODR issues).
PLUGINLIB_EXPORT_CLASS(
